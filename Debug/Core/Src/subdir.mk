...
C_SRCS += \
../Core/Src/controleModule.c \
../Core/Src/gpio.c \
../Core/Src/highLevelModule.c \
../Core/Src/main.c \
../Core/Src/nRF24L01_test-lib.c \
...
OBJS += \
./Core/Src/controleModule.o \
./Core/Src/gpio.o \
./Core/Src/highLevelModule.o \
./Core/Src/main.o \
./Core/Src/nRF24L01_test-lib.o \
...
C_DEPS += \
./Core/Src/controleModule.d \
./Core/Src/gpio.d \
./Core/Src/highLevelModule.d \
./Core/Src/main.d \
./Core/Src/nRF24L01_test-lib.d \
...
Core/Src/highLevelModule.o: ../Core/Src/highLevelModule.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DSTM32F103xB -DDEBUG -c -I../Drivers/CMSIS/Device/ST/STM32F1xx/Include -I../Drivers/CMSIS/Include -I../Core/Inc -I../Drivers/STM32F1xx_HAL_Driver/Inc/Legacy -I../Drivers/STM32F1xx_HAL_Driver/Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/highLevelModule.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
...
Core/Src/nRF24L01_test-lib.o: ../Core/Src/nRF24L01_test-lib.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DSTM32F103xB -DDEBUG -c -I../Drivers/CMSIS/Device/ST/STM32F1xx/Include -I../Drivers/CMSIS/Include -I../Core/Inc -I../Drivers/STM32F1xx_HAL_Driver/Inc/Legacy -I../Drivers/STM32F1xx_HAL_Driver/Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/nRF24L01_test-lib.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
Core/Src/settingModule.o: ../Core/Src/settingModule.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DSTM32F103xB -DDEBUG -c -I../Drivers/CMSIS/Device/ST/STM32F1xx/Include -I../Drivers/CMSIS/Include -I../Core/Inc -I../Drivers/STM32F1xx_HAL_Driver/Inc/Legacy -I../Drivers/STM32F1xx_HAL_Driver/Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/settingModule.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
